        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8 font-body">
              Experiência completa de adoração onde quer que você esteja. Áudio
              impecável, estabilidade e interface intuitiva.
            </p>
          ...
          >
            ...
            <div className="relative w-[320px] md:w-[380px] animate-float">
              {/* Phone frame */}
              <div
                className="relative rounded-[3rem] border-[8px] border-foreground/20 bg-background overflow-hidden shadow-2xl"
